...
Or if you want to use the points as urls:
...
da_client:
  eigen:
    ...
    authenticated: false
    points_source_url:
      g1_url: https://github.com/lambdaclass/zksync-eigenda-tools/raw/refs/heads/initial-impl/resources/g1.point
      g2_url: https://github.com/lambdaclass/zksync-eigenda-tools/raw/refs/heads/initial-impl/resources/g2.point.powerOf2
```
